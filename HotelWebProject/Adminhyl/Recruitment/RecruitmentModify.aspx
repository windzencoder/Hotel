<%@ Page Title="" Language="C#" MasterPageFile="~/Adminhyl/Adminhyl.Master" AutoEventWireup="true"
    CodeBehind="RecruitmentModify.aspx.cs" Inherits="HotelWebProject.Adminhyl.Recruitment.RecruitmentModify" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="server">
    <div class="txtContentdiv">
      ...
      职位编号：<asp:Literal ID="ltaPostId" runat="server"></asp:Literal>
        ...
        <div class="txtItemdiv">
            <asp:Button ID="btnPublish" CssClass="btncss" runat="server" Text="提交修改" 
               />
